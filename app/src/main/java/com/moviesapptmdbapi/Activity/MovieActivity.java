...
//        Movie método
    ...
    private void initUI() {
        ...
        reviewLabel = findViewById(R.id.reviewsLabel);
    }
    ...
    private void getGenres(final Movie movie) {
        moviesRepository.getGenres(new OnGetGenresCallback() {
            @Override
            public void onSuccess(List<Genre> movies) {
                ...
                for (final Trailer trailer : trailers) {
                    ...
                    thumbnail.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            showTrailers(String.format(YOUTUBE_VIDEO_URL, trailer.getKey()));
                        }
                    });

                    Glide.with(MovieActivity.this)
                            .load(String.format(YOUTUBE_THUMBNAIL_URL, trailer.getKey()))
                            .apply(RequestOptions.placeholderOf(R.drawable.icon).centerCrop())
                            .into(thumbnail);
        ...
        moviesRepository.getReviews(movie.getId(), new OnGetReviewsCallback() {
            ...
            public void onSuccess(List<Review> reviews) {
                ...
                for (Review review : reviews) {
                    View parent = getLayoutInflater().inflate(R.layout.review_activity, movieReviews, false);
